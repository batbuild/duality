...
namespace Duality.Components.Renderers
{
	...
	{
		private static TimeCounter BoundRadiusCounter = Profile.RequestCounter<TimeCounter>(Profile.TimeIsVisible.FullName + "\\TextRenderer");
		...
		public override float BoundRadius
		{
			get 
			{
				using (BoundRadiusCounter.ProfileScope)
				{
