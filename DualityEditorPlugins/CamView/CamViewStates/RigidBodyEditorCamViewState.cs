...
namespace Duality.Editor.Plugins.CamView.CamViewStates
{
	...
	//	private	ToolStripButton		toolCreateEdge		= null;
		...
		protected override string UpdateStatusText()
		{
			if (this.mouseState != CursorState.Normal)
			{
				if (this.mouseState == CursorState.CreateCircle)		return Properties.CamViewRes.ColliderEditor_CreateCircle;
				else if (this.mouseState == CursorState.CreatePolygon)	return Properties.CamViewRes.ColliderEditor_CreatePolygon;
				else if (this.mouseState == CursorState.CreateLoop)		return Properties.CamViewRes.ColliderEditor_CreateLoop;
			}
